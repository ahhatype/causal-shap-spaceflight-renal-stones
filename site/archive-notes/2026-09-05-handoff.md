...
# Historical handoff: 5 September 2026
...
See [redesign notes](../../docs/reviews/tutorial-redesign-notes.md) and the
[page review](../../docs/reviews/tutorial-page-review-2026-09-05.md).
...
1. Pull this hub's `main`; read [ORIENTATION.md](../../ORIENTATION.md),
   ...
   [full-DAG research record](../../docs/full_dag/RESEARCH_RECORD.md). Reconcile any
...
2. Use Python 3.13 (the CI version; supported range is 3.11–3.13), R and
   ...
   [reproducibility guide](../../docs/full_dag/REPRODUCIBILITY_AND_SITE.md) for R stages.
3. Confirm the private LumaWarp runtime and provider are available locally.
   ...
   [ADR 008](../../docs/decisions/008-lumawarp-detector-placeholders.md). Steps 5 and 7
...
- Prespecify the E1–E3 teaching stress tests and repeated-seed evaluation in
  [the framing memo](../../docs/framing/prediction-vs-intervention.md) and
  [the detector outline](../../docs/lumawarp/README.md). Freeze the graph, coefficients,
